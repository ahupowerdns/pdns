...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
To change or add trust anchors at runtime, use the :doc:`rec_control` tool.
...
The :doc:`rec_control` command can be used to manage the negative trust anchors of a running instance.
