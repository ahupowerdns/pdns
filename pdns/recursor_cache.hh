...
public:
  ...
  unsigned int size();
  unsigned int bytes();
  int get(time_t, const DNSName &qname, const QType& qt, bool needAuth, vector<DNSRecord>* res, const ComboAddress& who, vector<std::shared_ptr<RRSIGRecordContent>>* signatures=0);
