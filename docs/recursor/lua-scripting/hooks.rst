...
.. function:: gettag(remote, ednssubnet, local, qname, qtype, ednsoptions, tcp) -> int
    ...
    :param {int: EDNSOptionView} ednsoptions: A table whose keys are EDNS option codes and values are :class:`EDNSOptionView` objects. This table is empty unless the :ref:`setting-gettag-needs-edns-options` option is set.
...
.. literalinclude:: ../../../pdns/kv-example-script.lua
    :language: Lua

Example Script
--------------

.. literalinclude:: ../../../pdns/powerdns-example-script.lua
    :language: Lua
